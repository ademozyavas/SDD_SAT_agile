...
(assign! (value-var-id 'b 1) 0)
(assign! (value-var-id 'c 1) 1)
(assign! (value-var-id 'd 1) 1)

(assign! (value-var-id 'n1 1) 0)
(assign! (value-var-id 'n2 1) 0)
(assign! (value-var-id 'n3 1) 0)
(assign! (value-var-id 'out 1) 1)
...
;; n1: 0 -> 1
(assign! (transition-var-id 'n1) 0)

;; n3: 0 -> 1
(assign! (transition-var-id 'n3) 0)

;; out: 1 -> 0
(assign! (transition-var-id 'out) 0)
...
(if (null? failed-clauses)
    ...
    (begin
      (printf "\n[FAIL] Invalid sensitization was accepted!\n")
      (printf "The 3F constraints should reject this assignment.\n"))

    (begin
      (printf "\n[PASS] Invalid sensitization assignment was rejected.\n")
      (printf "Number of failed clauses: ~a\n"
              (length failed-clauses))))
